...
async function main() {
        ...
        const productVariants = await Promise.all([
            prisma.productVariant.create({
                data: {
                    productId: product.id,
                    name: '5 kg',
                    price: Number(product.price) * 4.8,
            ...
            prisma.productVariant.create({
                data: {
                    productId: product.id,
                    name: '10 kg',
                    price: Number(product.price) * 9.5,
    ...
    const notifications = await Promise.all([
        ...
        prisma.notification.create({
            data: {
                userId: sellers[0].id,
                type: client_1.NotificationType.NEW_REVIEW,
